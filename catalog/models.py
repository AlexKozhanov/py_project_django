...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category,
                                 ...
                                 null=True,
                                 blank=True)
    price = models.FloatField(max_length=100, verbose_name='Цена', help_text='Введите цену продукта')
    created_at = models.DateField(max_length=100, verbose_name='Дата создания', help_text='Введите  продукта')
    updated_at = models.DateField(max_length=100, verbose_name='Дата последнего изменения',
